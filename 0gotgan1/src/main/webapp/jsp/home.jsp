    ...
    <section>
        ...
        <div class="row mb-4">
            ...
            <div class="col-6 d-flex justify-content-end align-items-center">
                ...
                <a href="../food/foodList.do" class="b1">더보기</a>
            </div>
        </div>
    ...
    <div class="container-fluid tm-container-content tm-mt-60">
        <div class="row mb-4">
            ...
            <div class="col-6 d-flex justify-content-end align-items-center">
                ...
                <a href="../list/recipeList.do" class="b1">더보기</a>
            </div>
        </div>
    ...
    <div class="container-fluid tm-container-content tm-mt-60">
        <div class="row mb-4">
            ...
            <div class="col-6 d-flex justify-content-end align-items-center">
                ...
                <a href="../product/productList.do" class="b1">더보기</a>
            </div>
        </div>
        <div class="row tm-mb-90 tm-gallery">
    ...
    <div class="container-fluid tm-container-content tm-mt-60">
        <div class="row mb-4">
            ...
            <div class="col-6 d-flex justify-content-end align-items-center">
                ...
                <a href="../share/shareList.do" class="b1">더보기</a>
            </div>
        </div>
        <div class="row tm-mb-90 tm-gallery">
        <!-- forEachh -->
