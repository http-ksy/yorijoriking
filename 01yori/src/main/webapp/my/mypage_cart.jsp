  ...
  // IMP.request_pay(param, callback) 결제창 호출
	IMP.request_pay({
	    ...
	    if ( rsp.success ) {
	        ...
	        location.href="../my/mypage_buy.do";
	    }
	});
}
</script>
	...
	<table class="table" style="width: 1000px;">
		...
		<c:forEach var="vo" items="${list }">
			<tr>
				...
				<td class="text-center">
					<input type="button" class="btn btn-sm btn-danger" value="구매" id="buyBtn" data-no="${vo.cart_no }">
					<a href="../my/cart_cancel.do?pdno=${vo.cart_no }" class="btn btn-sm btn-success">취소</a>
				</td>
			</tr>
		</c:forEach>
	</table>
