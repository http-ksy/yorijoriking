	 ...
	 <div class="container">
        <div class="container">
            <h2 class="col-6 tm-text-primary ">
             ...
             <a href="../list/recipeList.do?type=all" class="btn btn-xs b1">전체</a>
            <a href="../list/recipeList.do?type=soup" class="btn btn-xs b1">국/탕</a>
            <a href="../list/recipeList.do?type=maindish" class="btn btn-xs b1">메인반찬</a>
            <a href="../list/recipeList.do?type=sidedish" class="btn btn-xs b1">사이드반찬</a>
            </div>
