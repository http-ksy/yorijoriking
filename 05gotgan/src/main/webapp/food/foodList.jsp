...
<!--             <input type="button" value="전체보기" class="btn btn-xs b1"> -->
             <a href="../food/foodList.do?type=0" class="btn btn-xs b1"><b>All</b></a>
            <a href="../food/foodList.do?type=1" class="btn btn-xs b1"><b>한식</b></a>
            <a href="../food/foodList.do?type=2" class="btn btn-xs b1"><b>양식</b></a>
            <a href="../food/foodList.do?type=3" class="btn btn-xs b1"><b>일식</b></a>
